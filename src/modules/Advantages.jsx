const AdvantagesSection = () => {
    return (
        <section className="advantages" id="переваги">
            <h2 className="advantages__title">Мої переваги</h2>
            <div className="advantages__list">
                <div className="advantages__item">
                    <svg
                        className="advantages__svg"
                        version="1.1"
                    ...
                    <p>Мій професійний досвід охоплює понад 10 років успішної роботи у сфері права</p>
                </div>
                <div className="advantages__item">
                    <svg
                        className="advantages__svg"
                    ...
                    <p>
                        Я завжди дотримуюся індивідуального підходу до кожного клієнта, враховуючи його унікальні
                        потреби та цілі
                    </p>
                </div>
                <div className="advantages__item">
                    ...
                    <p>Моя робота завжди спрямована на досягнення високих результатів із максимальною ефективністю</p>
                </div>
            </div>
        </section>
    );
